...
export const idAndMovie: { id: string; movie: Movie } = {
...
export const idAndQuote: { id: string; quote: Quote } = {
...
export const budgetUnder100: Movie[] = [
  {
    _id: "5cd95395de30eff6ebccde5b",
    name: "The Two Towers",
    runtimeInMinutes: 179,
...
export const greaterOrEqual94Tomatoes: Movie[] = [
  {
    _id: "5cd95395de30eff6ebccde56",
    name: "The Lord of the Rings Series",
    runtimeInMinutes: 558,
